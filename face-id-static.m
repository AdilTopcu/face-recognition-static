...
AgirlikliFarklarinMatrisi = abs(KayitliYuzAgirlikliMatrisi - 
AgirlikliMatris)
...
AdilinOrtalamaFark = 
prod(AdilinAgirlikliFarklarinMatrisi,2)^(1/AdilinAgirlikliFarklarinMatrisininElemanSayisi)
...
EmininOrtalamaFark = 
prod(EmininAgirlikliFarklarinMatrisi,2)^(1/EmininAgirlikliFarklarinMatrisininElemanSayisi)
...
EgeninOrtalamaFark = 
prod(EgeninAgirlikliFarklarinMatrisi,2)^(1/EgeninAgirlikliFarklarinMatrisininElemanSayisi)
...
IzzetinOrtalamaFark = 
prod(IzzetinAgirlikliFarklarinMatrisi,2)^(1/IzzetinAgirlikliFarklarinMatrisininElemanSayisi)
...
MelisinOrtalamaFark = 
prod(MelisinAgirlikliFarklarinMatrisi,2)^(1/MelisinAgirlikliFarklarinMatrisininElemanSayisi)
